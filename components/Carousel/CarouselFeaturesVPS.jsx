            ...
            <>
              ...
              <div className="flex flex-1 justify-center pt-0 h-[1px]" style={{listStyle: 'none'}}>
                {(() => {
                  ...
                  for (let i = 0; i < FeatureVPSData.length; i++) {
              ...
              <div className="text-[#71747d] font-bold ml-10">
                <span className="text-lg">{currentSlide + 1}/{FeatureVPSData.length}</span>
              </div>              
            </>
          )}
        </div>
...
export default CarouselFeaturesVPS;
