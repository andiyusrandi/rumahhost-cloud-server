...
import { CloudHostingDesaFeaturesData } from "@/utils/data";
import { Icon } from "@iconify/react";
import { useKeenSlider } from "keen-slider/react.esm.js"
import { useState } from "react";
import "keen-slider/keen-slider.min.css"

function CarouselCloudHostingDesa() {
    ...
    <div className="lg:col-span-4">
      <div className="lg:overflow-hidden overflow-x-scroll px-2.5 pb-2.5 -mx-2.5">
        <div className="keen-slider lg:overflow-hidden overflow-x-scroll" ref={sliderRef}>
          {CloudHostingDesaFeaturesData.map((data, index) => (
            <div
              key={index}
            ...
            <>
              ...
              <div className="flex flex-1 justify-center pt-0 h-[1px]" style={{listStyle: 'none'}}>
                {(() => {
                  ...
                  for (let i = 0; i < CloudHostingDesaFeaturesData.length; i++) {
              ...
              <div className="text-[#71747d] font-bold ml-10">
                <span className="text-lg">{currentSlide + 1}/{CloudHostingDesaFeaturesData.length}</span>
              </div>              
            </>
          )}
        </div>
...
export default CarouselCloudHostingDesa;
