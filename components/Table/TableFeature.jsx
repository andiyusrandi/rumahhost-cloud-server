        ...
        <div className="overflow-x-auto whitespace-nowrap md:whitespace-normal">
          <table>
            <tbody>
              ...
              <tr>
                <td>Database</td>
                <td>{datas[0].feature.MAXSQL}</td>
                <td>{datas[1].feature.MAXSQL}</td>
                <td>{datas[2].feature.MAXSQL}</td>
              </tr>
              <tr>
                <td>Addon Domain</td>
              ...
              <tr>
                <td>Sub Domain</td>
                <td>{datas[0].feature.MAXSUB}</td>
                <td>{datas[1].feature.MAXSUB}</td>
                <td>{datas[2].feature.MAXSUB}</td>
              </tr>
              <tr>
                <td>Lokasi Server</td>
                <td>
